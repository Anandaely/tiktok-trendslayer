# TikTok 选品猎手 (tiktok-trend-slayer)

> 自动监控 TikTok 商品榜与达人榜，AI 挖掘高增长爆款，生成选品及达人撮合策略

---

## 🎯 技能描述

**TikTok 选品猎手**是一款面向 TikTok 电商卖家的智能选品工具。通过自动监控 TikTok Shop 商品榜、EchoTik 数据接口，实时识别高增长爆款商品，并利用 AI 分析爆款视频的钩子（Hook）与结构，自动匹配合适的中腰部达人（KOC），帮助卖家快速发现蓝海品类与合作机会。
